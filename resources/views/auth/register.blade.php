...
<head>
    ...
    <style>
        ...
        .form-check-input[type="radio"]:checked + .form-check-label .border {
        ...
        .form-check .border:hover {
            border-color: #2E90FA !important;
            box-shadow: 0 2px 8px rgba(46, 144, 250, 0.15);
        }
...
<body>
    ...
    <script>
        ...
        function toggleDoctorFields() {
            ...
            const requiredFields = ['str_number', 'specialization', 'hospital_name', 'phone_number', 'years_of_experience'];
            
            if (roleDoctor.checked) {
                doctorFields.style.display = 'block';
                // Set required untuk field dokter
                ...
                // Hapus required untuk field dokter
                requiredFields.forEach(fieldId => {
                    const field = document.getElementById(fieldId);
        ...
        // Jalankan saat halaman dimuat untuk menampilkan field jika old value adalah doctor
