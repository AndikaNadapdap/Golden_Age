...
Route::post('/articles/{id}/like', [ArticleController::class, 'like'])->middleware('auth')->name('articles.like');

// Resep MPASI (Public)
Route::get('/recipes', [RecipeController::class, 'index'])->name('recipes.index');
Route::get('/recipes/{slug}', [RecipeController::class, 'show'])->name('recipes.show');
Route::post('/recipes/{id}/like', [RecipeController::class, 'like'])->middleware('auth')->name('recipes.like');

// Stimulasi & Permainan (Public)
...
Route::post('/discussions/{id}/reply', [DiscussionController::class, 'reply'])->middleware('auth')->name('discussions.reply');
